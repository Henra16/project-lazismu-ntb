...
<?php $__env->startSection('title', 'Detail Donasi - Lazismu NTB'); ?>
        ...
        <div class="card border-0 shadow-sm rounded-4 p-4 p-md-5">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start gap-3 mb-4">
                <div>
                    ...
                    <p class="text-muted mb-0">Nomor Donasi: <strong><?php echo e($donation->uuid); ?></strong></p>
                </div>
                <div class="text-end">
                    <span class="badge bg-<?php echo e($donation->status === 'paid' ? 'success' : ($donation->status === 'pending' ? 'warning' : 'danger')); ?> text-capitalize py-2 px-3"><?php echo e($donation->status); ?></span>
                </div>
            </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="info-card p-4 rounded-4 bg-light">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="fw-semibold"><?php echo e($donation->donor_name); ?></div>
                        </div>
                        <div class="mb-3">
                            <div class="text-muted small">Email</div>
                            <div class="fw-semibold"><?php echo e($donation->donor_email); ?></div>
                        </div>
                        <div class="mb-3">
                            <div class="text-muted small">No. Telepon</div>
                            <div class="fw-semibold"><?php echo e($donation->donor_phone); ?></div>
                        </div>
                        <div>
                            <div class="text-muted small">Program</div>
                            <div class="fw-semibold"><?php echo e($donation->program?->title ?? '-'); ?></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="info-card p-4 rounded-4 bg-light">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="fw-semibold text-uppercase"><?php echo e(str_replace('_', ' ', $donation->payment_method)); ?></div>
                        </div>
                        <div class="mb-3">
                            <div class="text-muted small">Jumlah Donasi</div>
                            <div class="fw-semibold">Rp <?php echo e(number_format($donation->amount, 0, ',', '.')); ?></div>
                        </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($donation->admin_fee > 0): ?>
                            <div class="mb-3">
                                ...
                                <div class="fw-semibold">Rp <?php echo e(number_format($donation->admin_fee, 0, ',', '.')); ?></div>
                            </div>
                            <div class="mb-3 pb-3 border-bottom">
                                <div class="text-muted small">Total Pembayaran</div>
                                <div class="fw-semibold fs-5">Rp <?php echo e(number_format($donation->amount + $donation->admin_fee, 0, ',', '.')); ?></div>
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <div class="mb-3">
                            <div class="text-muted small">Tanggal Transaksi</div>
                            <div class="fw-semibold"><?php echo e($donation->created_at->format('d M Y, H:i')); ?> WITA</div>
                        </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($donation->paid_at): ?>
                            <div>
                                ...
                                <div class="fw-semibold"><?php echo e($donation->paid_at->format('d M Y, H:i')); ?> WITA</div>
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                </div>
            ...
            <div class="mt-4 p-4 rounded-4 border bg-white">
                ...
                <div class="row gy-3">
                    <div class="col-12 col-md-6">
                        ...
                        <div class="fw-semibold"><?php echo e($donation->transaction?->order_id ?? '-'); ?></div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="text-muted small">Status Gateway</div>
                        <div class="fw-semibold text-capitalize"><?php echo e($donation->transaction?->transaction_status ?? 'pending'); ?></div>
                    </div>
                    <div class="col-12">
                        <div class="text-muted small">Catatan Donasi</div>
                        <div class="fw-semibold"><?php echo e($donation->doa ?? '-'); ?></div>
                    </div>
                </div>
            </div>

            <div class="mt-4 d-flex flex-column flex-md-row gap-3">
                <a href="<?php echo e(auth()->check() && $donation->user_id === auth()->id() ? route('donasi.history') : route('donasi.check')); ?>" class="btn btn-outline-secondary btn-lg flex-fill">Kembali</a>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($donation->status === 'pending'): ?>
                    <div class="d-flex gap-2 flex-fill flex-column flex-sm-row">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($donation->transaction && $donation->transaction->gateway_name === 'tripay' && data_get($donation->transaction->raw_response, 'checkout_url')): ?>
                            <a href="<?php echo e(data_get($donation->transaction->raw_response, 'checkout_url')); ?>" class="btn btn-warning btn-lg flex-fill">Lanjutkan Pembayaran</a>
                        <?php elseif($donation->payment_method === 'transfer_manual' || $donation->payment_method === 'va_ntb_syariah'): ?>
                            <a href="<?php echo e(route('donasi.manual', $donation->uuid)); ?>" class="btn btn-warning btn-lg flex-fill">Lihat Instruksi Pembayaran</a>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <form action="<?php echo e(route('donasi.cancel', $donation->uuid)); ?>" method="POST" class="flex-fill" id="form-batalkan-donasi">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('frontend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ASUS\Herd\project-lazismu-ntb\resources\views/frontend/donasi/invoice.blade.php ENDPATH**/ ?>