<?php $__env->startSection('title', 'Donasi Sekarang - Lazismu NTB'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="donasi-container">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request('program')): ?>
            <?php
            ...
            <div class="program-selected-card mb-4">
                <div class="d-flex align-items-center">
                    <img src="<?php echo e($pImg); ?>" alt="<?php echo e($pName); ?>" class="program-selected-img">
                    <div class="program-selected-info">
                        <span class="badge-terpilih">Anda akan berdonasi untuk program:</span>
                        <h3 class="title-terpilih"><?php echo e($pName); ?></h3>
                    </div>
                </div>
            </div>
        ...
        <div class="donasi-card-main">
            <form id="form-donasi" method="POST" action="#">
                        ...
                        <div class="donasi-form-group">
                            ...
                            <div class="select-wrapper">
                                <select id="select-program" name="program_select">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = \App\Models\Program::where('is_active', true)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <option value="<?php echo e($program->slug); ?>" data-title="<?php echo e($program->title); ?>"><?php echo e($program->title); ?></option>
                ...
                <input type="hidden" name="program_slug" id="hidden-program-slug" value="<?php echo e(request('program')); ?>">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function updateProgramInSummary(slug, title) {
        if (slug && title) {
            ...
            <?php if(request('program')): ?>
            displayProgram.textContent = '<?php echo e($pName ?? ""); ?>';
            rowProgram.style.display = 'flex';
            <?php else: ?>
    ...
    <?php if(request('program')): ?>
    updateProgramInSummary('<?php echo e(request("program")); ?>', '<?php echo e($pName ?? ""); ?>');
    <?php endif; ?>
    ...
    document.getElementById('form-donasi').addEventListener('submit', function(e) {
        ...
        fetch('<?php echo e(route("donasi.store")); ?>', {
            method: 'POST',
            headers: {
...
<?php echo $__env->make('frontend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ASUS\Herd\project-lazismu-ntb\resources\views/frontend/donasi/index.blade.php ENDPATH**/ ?>