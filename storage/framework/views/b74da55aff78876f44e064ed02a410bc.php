...
<footer class="footer-lazismu" id="footer-main">
    <div class="container">
        ...
        <div class="footer-bottom">
            <p>&copy; <?php echo e(date('Y')); ?> Lazismu Nusa Tenggara Barat. All rights reserved.</p>
        </div>
    </div>
</footer><?php /**PATH C:\Users\ASUS\Herd\project-lazismu-ntb\resources\views/frontend/components/footer.blade.php ENDPATH**/ ?>