...
@section('title', 'Instruksi Transfer Manual - Lazismu NTB')
    ...
    <div class="container" style="max-width: 650px;">
        <div class="card payment-card border-0 shadow-lg p-4 p-md-5 text-center">
            ...
            <div class="program-summary p-3 mb-4 rounded-3 text-start">
                ...
                <strong class="text-dark">{{ $donation->program->title }}</strong>
            </div>
            ...
            <div class="amount-box p-4 mb-4 rounded-3 text-center">
                ...
                <div class="d-flex justify-content-center gap-2 mt-2">
                    <button class="btn btn-outline-secondary btn-sm btn-copy" data-clipboard="{{ $donation->amount }}">
            ...
            <div class="bank-details-box text-start p-4 mb-4 rounded-3 border">
                ...
                <div class="mb-3">
                    ...
                    <strong class="text-dark fs-5">{{ $bankDetails['bank_name'] }}</strong>
                </div>

                <div class="mb-3 position-relative">
                    <span class="text-muted d-block small">Nomor Rekening</span>
                    <div class="d-flex align-items-center justify-content-between">
                        <strong class="text-dark fs-4" id="account-number">{{ $bankDetails['account_number'] }}</strong>
                        <button class="btn btn-outline-primary btn-sm btn-copy" data-clipboard="{{ str_replace('-', '', $bankDetails['account_number']) }}">
            ...
            <div class="d-flex flex-column gap-2">
                ...
                @endphp
                <a href="{{ $waLink }}" target="_blank" class="btn btn-success btn-lg py-3 fw-bold rounded-3">
                    <i class="fab fa-whatsapp me-2"></i> Konfirmasi via WhatsApp
                </a>
                <a href="{{ route('home') }}" class="btn btn-outline-secondary btn-lg py-3 rounded-3">
                    Kembali ke Beranda
                </a>
            </div>
